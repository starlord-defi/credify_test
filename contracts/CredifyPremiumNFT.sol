...
contract CredifyPremiumNFT is
    ERC721("CredifyPremiumNFT", "CP"),
    ERC721Burnable,
    ICredifyPremiumNFT
{
    ...
    function mintCredifyPremium(
        ...
        require(
            super.balanceOf(to) <= 1,
            "cannot have more than one nft badge"
        );
    ...
    function burnCredifyPremium(uint256 tokenId) external override {
