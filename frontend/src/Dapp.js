    ...
    const menu = (
        <Menu
            items={[
                ...
                {
                    label: <a onClick={wrapperFunction}><CopyOutlined /> Copy Address</a>,
                    key: '1',
                },
                {
                    label: <a href={`https://${currentNetwork}.etherscan.io/address/${address}`} target="_blank"><ExportOutlined /> View on Explorer</a>,
                    key: '2',
                },
                {
                    label: <Account
                        ...
                        <div>
                            {web3Modal?.cachedProvider ? <Dropdown className="user-dropdown" overlay={menu} trigger={['click']}>
                                <a onClick={(e) => e.preventDefault()}>
                                    <Space>
                                        <Avatar size="small" icon={<UserOutlined />} style={{ marginBottom: '0.3rem' }} />
